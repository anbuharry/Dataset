"""
   ...
   # TODO : OSError: Unable to create file (unable to lock file, errno = 11, error message = 'Resource temporarily unavailable')
"""
import os
from configss import configss
...
class Generate_Dataset:
    ...
    def _set_video_list(self, video_path):
        ...
        if os.path.isdir(video_path):
            ...
            fileExt = r".mp4", ".avi"
            self.video_list = [_ for _ in os.listdir(
                video_path) if _.endswith(fileExt)]
    ...
    def _generator(self, video_idx, video_filename):
        # video_idx = self._set_video_list(video_idx)
        print(video_idx)
        # import pdb;pdb.set_trace()
                ...
                if frame_idx % 15 == 0:
                    ...
                    if success:
                        ...
                        if video_feat_for_train is None:
                            ...
                            video_feat_for_train = np.vstack(
                                (video_feat_for_train, frame_feat))
        ...
        self.h5_file['video_{}'.format(
            video_idx+1)]['features'] = list(video_feat_for_train)
        self.h5_file['video_{}'.format(
            video_idx+1)]['picks'] = np.array(list(picks))
        self.h5_file['video_{}'.format(video_idx+1)]['n_frames'] = n_frames
        self.h5_file['video_{}'.format(video_idx+1)]['fps'] = fps
        self.h5_file['video_{}'.format(
            video_idx + 1)]['video_name'] = video_filename.split('.')[0]
...
#     Parallel(n_jobs=-1)(delayed(self._generator)(video_idx, video_filename)
#                         for video_idx, video_filename in enumerate(self.video_list))
